...
const PROVIDER_META: Provider = {
  ...
  name: "Mock Provider",
  description:
    "Returns deterministic demo data for development and testing. No external API calls.",
...
const RED_PLAYER_CARDS: PlayerCardPrediction[] = [
  {
    ...
    playerName: "C. Press",
    teamId: "manchester-red",
    yellowCardProbability: 0.42,
    foulProbability: 0.52,
  },
  {
    playerId: "red-5",
    playerName: "R. Block",
    teamId: "manchester-red",
    yellowCardProbability: 0.31,
    foulProbability: 0.44,
  },
  {
    playerId: "sha-6",
    playerName: "D. Anchor",
    teamId: "shanghai-harbor",
    yellowCardProbability: 0.38,
    foulProbability: 0.48,
  },
  {
    playerId: "sha-10",
    playerName: "S. Late",
    teamId: "shanghai-harbor",
    yellowCardProbability: 0.26,
    redCardRiskLevel: "low",
    foulProbability: 0.35,
  },
];
  ...
  async fetchLineup(matchId: string, teamId: string): Promise<Lineup> {
    ...
    if (teamId === "manchester-red") {
      return {
        ...
        teamId,
        formation: "4-2-3-1",
        starters: structuredClone(RED_STARTERS),
        substitutes: structuredClone(RED_SUBS),
        coach: "R. Manager",
      };
    }
    if (teamId === "shanghai-harbor") {
      return {
        ...
        teamId,
        formation: "4-4-2",
        starters: structuredClone(SHA_STARTERS),
        substitutes: structuredClone(SHA_SUBS),
        coach: "L. Tactician",
      };
    }
    throw new Error(`Mock: unknown team ${teamId}`);
